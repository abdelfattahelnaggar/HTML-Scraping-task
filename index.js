...
<li id="menu-item-634" class="ld-button met-link menu-item menu-item-type-custom menu-item-object-custom menu-item-634"><a href="https://cloudnativebasecamp.com/bab/?action=logout&#038;redirect_to=https%3A%2F%2Fcloudnativebasecamp.com%2Fcourses%2Fnode-js-from-scratch%2F&#038;_wpnonce=70c0d59a83">خروج</a></li>
</ul>		</div>
	</nav><!-- #site-navigation -->
	</div><!-- data-section="primary_navigation" -->
<div class="site-header-item site-header-focus-item" data-section="kadence_customizer_header_html">
	<div class="header-html inner-link-style-normal"><div class="header-html-inner"><div class="met_user_info">abdelfattah_elnaggar</div>
...
<div class="learndash-wrapper">
	...
	<div class="learndash-wrapper learndash-wrap learndash-shortcode-wrap learndash-shortcode-wrap-ld_infobar-4467_4467_3817">
	...
	<div class="ld-course-status ld-course-status-enrolled">
			...
			ld-progress-inline">
					...
					<div class="ld-progress-steps rtl">
						اخر مرة درست الكورس ده  2024-10-30 23:01 pm					</div>
				</div> <!--/.ld-progress-stats-->
			</div>

			<div class="ld-progress-bar">
				<div class="ld-progress-bar-percentage ld-secondary-background" style="width:45%"></div>
			</div>
				</div> <!--/.ld-progress-->
...
<div class="learndash-wrapper learndash-wrap learndash-shortcode-wrap learndash-shortcode-wrap-course_content-4467_4467_3817"><div class="learndash user_has_access" id="learndash_post_4467">		<div class="learndash-wrapper">
						<div class="ld-item-list ld-lesson-list ld-course-content-4467" data-shortcode_instance="{&quot;course_id&quot;:4467,&quot;post_id&quot;:4467,&quot;group_id&quot;:0,&quot;paged&quot;:1,&quot;num&quot;:100,&quot;wrapper&quot;:true,&quot;user_id&quot;:3817}">
...
<div class="ld-item-list-item ld-item-lesson-item ld-lesson-item-7227 is_not_sample learndash-incomplete" id="ld-expand-7227" data-ld-expand-id="ld-expand-7227" >
	<div class="ld-item-list-item-preview">
...
<div class="footer-widget-area site-info site-footer-focus-item content-align-default content-tablet-align-default content-mobile-align-default content-valign-default content-tablet-valign-default content-mobile-valign-default" data-section="kadence_customizer_footer_html">
	...
	<div class="mobile-html inner-link-style-normal"><div class="mobile-html-inner"><div class="met_user_info">abdelfattah_elnaggar</div>
...
<li class="ld-button met-link menu-item menu-item-type-custom menu-item-object-custom menu-item-634"><a href="https://cloudnativebasecamp.com/bab/?action=logout&#038;redirect_to=https%3A%2F%2Fcloudnativebasecamp.com%2Fcourses%2Fnode-js-from-scratch%2F&#038;_wpnonce=70c0d59a83">خروج</a></li>
</ul>		</div>
	</nav><!-- #site-navigation -->
...
<div class="site-header-item site-header-focus-item" data-section="kadence_customizer_mobile_button">
	...
	<link rel='stylesheet' id='dashicons-css' href='https://cloudnativebasecamp.com/wp-includes/css/dashicons.min.css?ver=6.4.5' media='all' />
<link rel='stylesheet' id='admin-bar-css' href='https://cloudnativebasecamp.com/wp-includes/css/admin-bar.min.css?ver=6.4.5' media='all' />
<link rel='stylesheet' id='wpcom-notes-admin-bar-css' href='https://s0.wp.com/wp-content/mu-plugins/notes/admin-bar-v2.css?ver=13.6.1-202444-lite' media='all' />
<link rel='stylesheet' id='noticons-css' href='https://s0.wp.com/i/noticons/noticons.css?ver=13.6.1-202444-lite' media='all' />
...
<script src="https://s0.wp.com/wp-content/mu-plugins/notes/notes-common-lite.min.js?ver=13.6.1-202444-lite" id="wpcom-notes-common-js"></script>
<script id="wpcom-notes-admin-bar-js-before">
var wpNotesArgs = {"cacheBuster":"13.6.1-202444-lite"};
</script>
<script src="https://s0.wp.com/wp-content/mu-plugins/notes/admin-bar-v2.js?ver=13.6.1-202444-lite" id="wpcom-notes-admin-bar-js"></script>
 ...
 * find all divs with this class. the start and the end of this div
 *
 * start loop
 * -- find start_index of ("ld-item-title">)
 * -- find end_index of (</div>)
 * -- extract substring
 * end loop
 *
 * you will convert the html symbols to real chars
 */
  ...
  if (start_index > -1 && end_index > -1) {
    ...
    /*
		"ld-item-title">
				01 &#8211; Prepare Development Environment
		*/
    item = item.replaceAll('"ld-item-title">', "");
    /*
...
function replaceSymbols(str) {
  ...
  for (let i = 0; i < str.length; i++) {
    ...
    if (start_index > -1 && end_index > -1) {
      ...
      //8211
      let symbol = String.fromCharCode(parseInt(code));
      str = str.replaceAll("&#" + code + ";", symbol);
    }
  }
  return str;
}
